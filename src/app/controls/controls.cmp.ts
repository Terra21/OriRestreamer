  ...
  setBackground(background: string) {
    switch (background){
      ...
      case 'leftgrotto':
        ...
        this._vm.matchType = this.setDivisionName(this._vm.groupName);
      case 'catandmouse':
        this._vm.groupName = 'Semi Final';
        this._vm.matchType = this._vm.groupName;
    break;
    }
...
public set seed(seed: string){
  ...
  calculateP1Stat() {
    ...
    let runner1 = jQuery.grep(this.players, function(n: any, i) {
  ...
  calculateP2Stat(){
    ...
    let runner2 = jQuery.grep(this.players, function(n: any, i) {
